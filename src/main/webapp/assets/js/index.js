    ...
    */
    ...
    start: function() {
	 ...
	 /*   		  app.path.push(
	      ...
	      if(app.continueTrackingFlag){
	         setTimeout(track, app.timeout);
	      }
	  };
	  track();
    ...
    stop: function() {
        console.log('- Stoping');
        app.continueTrackingFlag=false;
        app.stopPositionWatch();
    ...
    setCurrentLocation: function(location) {
        ...
        app.latLngBounds.extend(latlng);
        app.map.fitBounds(app.latLngBounds);
