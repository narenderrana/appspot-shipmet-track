...
/*             zoom : 10, */
         ...
         shipmentLocation = new google.maps.Marker({
             map: map,
             icon: {
    	  ...
    	  var track = function() {
    	      $.ajax({
    	    	  ...
    	    	  success:function(dataIn){
    	    		  ...
    	    		  shipmentLocation.setPosition(latlang);
    	    		  locationAccuracy.setCenter(latlang);
    	    		  locationAccuracy.setRadius(shipmentLocation.accuracy);
...
/*              new google.maps.Marker({
            ...
            //polyline.setPath(path);
  		  shipmentLocation.setPosition(path[i]);
  		  locationAccuracy.setCenter(path[i]);
  		  locationAccuracy.setRadius(shipmentLocation.accuracy);
